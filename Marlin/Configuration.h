...
#define CUSTOM_MACHINE_NAME "Weldingbot Rod"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "e15d2f85-1638-41e7-afda-a9ac5014251f"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  10.76,  10.76 }
    #define DEFAULT_Ki_LIST {   0.61,   0.61 }
    #define DEFAULT_Kd_LIST { 47.17, 47.17 }
  #else
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 36, 0, -1.00 }
